...
class ProgressScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Safety: if user is null (logged out), show a simple message instead of crashing
    if (uid == null) {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
                ...
                builder: (context, snap) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      // ✅ Clickable mini-week preview (opens calendar)
                      _WeekPreview(
            ...
            // =========================
            // Week + Bars Card (like your images)
            // =========================
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ✅ Mini circle days — now clickable too
                      Row(
                        children: List.generate(7, (i) {
                          final day = data.days[i];
                          final ratio = data.ratios[i]; // 0..1
                          return Expanded(
                            child: _MiniDay(
...
/// ==============================
class _WeeklyBars {
  final List<DateTime> days; // 7 days
  final List<double> ratios; // 7 values 0..1
  ...
  static Future<_WeeklyBars> load(String uid) async {
    ...
    for (final habit in habitsSnap.docs) {
      final logsSnap = await habit.reference
          .collection('logs')
          .where('date', whereIn: keys) // date is yyyy-MM-dd
    ...
    final ratios = List<double>.generate(
      7,
      (i) => completedPerDay[i] / habitCount,
    );
